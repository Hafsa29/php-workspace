     	...
     	<section class="profile sixteen columns">
        	...
        	<ul>
                <?php foreach($solved as $s):?>
               	<li><a href="<?php echo site_url('index.php/online_judge/problem/').$s['p_id'];?>" class="links"><?php echo $s['p_given_name']; ?></a></li>
          		<?php endforeach; ?>
     	    </ul>
      	</section>
      	...
      	<section class="profile sixteen columns">
            <h2>Problems Tried</h2>
           	...
           	<ul>
               	...
               	<li><a href="<?php echo site_url('index.php/online_judge/problem/').$t['p_id'];?>" class="links"><?php echo $t['p_given_name']; ?></a></li>
       			<?php endforeach; ?>
  	        </ul>
      	</section>
        ...
        <section class="profile sixteen columns">
            <h2>Problems Submitted</h2>
           	...
           	<ul>
               	...
               	<li><a href="<?php echo site_url('index.php/online_judge/problem/').$p['p_id'];?>" class="links"><?php echo $p['p_given_name']; ?></a></li>
       			<?php endforeach; ?>
  	        </ul>
      	</section>
        ...
        <section class="profile sixteen columns">
            <h2>Tutorials Submitted</h2>
           	...
           	<ul>
               	...
               	<li><a href="<?php echo site_url('index.php/online_judge/tutorial/').$t['t_id'];?>" class="links"><?php echo $t['t_given_name']; ?></a></li>
       			<?php endforeach; ?>
  	        </ul>
      	</section>
